 ...
 * @version $Id: ProjectionGnomonic.js 2821 2015-02-20 16:59:27Z dcollins $
 */
define([
        '../geom/Angle',
        '../error/ArgumentError',
    ...
    function (Angle,
        ...
        var ProjectionGnomonic = function (pole) {
            ...
            GeographicProjection.call(this, "Polar Gnomonic", false, null);
        ...
        ProjectionGnomonic.prototype.geographicToCartesian = function (globe, latitude, longitude, elevation,
            ...
            if ((this.north && latitude === 90) || (!this.north && latitude === -90)) {
                ...
                var northSouthFactor = this.north ? -1 : 1,
                    a = (globe.equatorialRadius * (1/Math.tan(latitude * Angle.DEGREES_TO_RADIANS))) * northSouthFactor;

                result[0] = a * Math.sin(longitude * Angle.DEGREES_TO_RADIANS) * northSouthFactor;
        ...
        ProjectionGnomonic.prototype.cartesianToGeographic = function (globe, x, y, z, offset, result) {
            ...
            var rho = Math.sqrt(x * x + y * y),//20-18
                c;
            ...
            if (rho < 1.0e-4) {
                ...
                c = Math.atan2(rho, globe.equatorialRadius);//22-16
                if (c > Math.PI) {
                    c = Math.PI; // map cartesian points beyond the projection's radius to the edge of the projection
                }

                result.latitude = Math.asin(Math.cos(c) * (this.north ? 1 : -1)) * Angle.RADIANS_TO_DEGREES;//20-14
