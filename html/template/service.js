$(function () {
    $.widget("earthserver.service", {
        ...
        _create: function () {
            ...
            .addTab("contact", "contact", "Contact information", "", "<p>Project Manager - <a href=mailto:an.rossi@jacobs-university.de>Dr.Angelo Pio Rossi</a></p><p>Lead Developer - <a href=mailto:r.marcofiguera@jacobs-univesity.de>Ramiro Marco Figuera</a></p><p>Solution Developer - <a href=mailto:b.phamhuu@jacobs-university.de>Bang Pham Huu</a></p><p>Junior Developer - <a href=mailto:t.rankov@jacobs-university.de>Tsvetan Rankov</a></p>")
            ...
            .addTab("privacy", "privacy", "Privacy", "", "<p>Privacy statement can be found <a href=/data/privacy.html>here</a>.</p>");
            /* main dock (required) */
