$(function () {
    $.widget("dock.ratioDock", $.earthserver.dock, {
		...
		htmlElement += '<span style="color:white; margin-left: 40px;"><label style="font-weight: normal">Kernel (AxA pixels): </label><input id="txtKernelRatioChart" type="text" value="1" size="5" style="margin-left: 20px;color:blue;margin-left: 5px;font-size: 12px;"></span>';
