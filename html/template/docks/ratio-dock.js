    ...
    $.widget("dock.ratioDock", $.earthserver.dock, {
        ...
        _create: function () {
            ...
            var htmlElement = "<div style='margin-top: -70px; margin-bottom: 10px; color:white;'>";
                ...
                htmlElement += "<div class='radio' style='color:white;'> <label class='radio-inline'> <input type='radio' name='radioCharts' id='radioBtnAddChartRatioChart' >Add spectra</label> <label class='radio-inline'> <input type='radio' name='radioCharts' id='radioBtnUpdateChartRatioChart' checked>Update spectra</label>   <label>Range Charts </label> <input id='txtRangeChartsRatioChart' type='text' value='1-4' size='8' style='color:blue; margin-left: 10px;'> (µm)   <button type='button' id='btnClearChartsRatioChart' style='font-size: 10px; float: right;' class='btn btn-success'>Clear all spectra</button> </div> <hr style='margin-bottom: 7px; margin-top: 15px;'>";
                ...
                htmlElement += "<div class='chartdiv' id='bandRatioChartDiv' style='width:100%; height:480px;'></div>";
