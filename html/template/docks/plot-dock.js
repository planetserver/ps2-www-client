$(function () {
    $.widget("dock.plotDock", $.earthserver.dock, {
	    ...
	    htmlElement += "<div class='radio' style='color:white;'> <label class='radio-inline'> <input type='radio' name='radioCharts' id='radioBtnAddChartMainChart' >Add charts</label> <label class='radio-inline'> <input type='radio' name='radioCharts' id='radioBtnUpdateChartMainChart' checked>Update chart</label> <button type='button' id='btnClearChartsMultipleCharts' style='font-size: 10px; float: right; display:none;' class='btn btn-success'>Clear multiple clicked drawn charts</button> </div> <hr style='margin-bottom: 7px; margin-top: 15px;'>";	   
