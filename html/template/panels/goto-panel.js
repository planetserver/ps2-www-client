            ...
            this.panelBody
                .append(
                    $("<div id='gotoPanel' style='float: background-color: rgba(47, 85, 151, .2); '>"+
                      "<button id='viewLandingSites' type='button' class='btn btn-danger'>Show Landing Sites</button> &nbsp;" + 
                      "<button id='viewGazetteer' type='button' class='btn btn-info'>Show Gazetteer</button> <br/> " +
