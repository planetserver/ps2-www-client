            ...
            this.panelBody
                .append(
                    $("<div id='gotoPanel' style='float: background-color: rgba(47, 85, 151, .2); '>"+
                      ...
                      "Gazetteer: &nbsp; &nbsp; &nbsp; &nbsp; <label class='radio-inline'> <input type='radio' id='radioGazetteerShow' name='gazetteerOp'>Show </label> <label class='radio-inline'> <input type='radio' id='radioGazetteerHide' name='gazetteerOp'>Hide </label>" + 
