            ...
            this.panelBody
                .append(
                    $("<div id='gotoPanel' style='float: background-color: rgba(47, 85, 151, .2); '>"+
                      "<button id='viewLandingSites' type='button' class='btn btn-danger'>View Landing Sites</button> <br/> <table style='border-spacing: 10px; border-collapse: separate; width: 400px; color: white;'>"+
