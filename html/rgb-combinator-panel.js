$(function () {
    $.widget("panel.rgbCombinatorPanel", $.dock.panel, {
        ...
        _create: function () {
			...
			"<div class='dropdown' id='dropDownSelectedFootPrintsMenu' style='margin-top:20px; margin-left:-20px;'> <button class='btn btn-success dropdown-toggle' style='width:375px;' type='button' data-toggle='dropdown'>Selected Footprints To Combine RGB<span class='caret'></span></button> <ul class='dropdown-menu' id='dropDownSelectedFootPrints'> " +
			...
			// end selected Footprints dropdown
                                   ...
                                   "<div class='dropdown' style='margin-top:20px;'>"+
                                      "<button class='btn btn-default dropdown-toggle' type='button' id='menu1' data-toggle='dropdown' style='width:375px; margin-left:-20px;'>Coverage Bands To Combine RGB<span class='caret'></span></button>"+
                                      "<ul class='dropdown-menu scrollable-menu' role='menu' aria-labelledby='dropdownMenu' id='dropDownRGBBands' data-toggle='dropdown'>"+
                                      "</ul>"+
                                   "</div>"+
                                   "<div class='dropdown' style='margin-top:20px;'>"+
                                      "<button class='btn btn-default dropdown-toggle' type='button' id='menu2' data-toggle='dropdown' style='width:375px; margin-left:-20px;'>WCPS Custom Queries To Combine RGB<span class='caret'></span></button>"+
                                   ...
                                   "<form class='form-horizontal' role='form' style='margin-top:30px;'>"+
                                      "<div class='form-group'>"+
                                         ...
                                         "<table>"+
                                            "<tr>"+
                                               "<td><input type='red' class='form-control autocomplete' id='txt_rgb_red' style='width: 275px;' placeholder=''> </td>"+
                                      ...
                                      "<div class='form-group'>"+
                                         ...
                                         "<table>"+
                                            "<tr>"+
                                               "<td><input type='green' class='form-control autocomplete' id='txt_rgb_green' style='width: 275px;' placeholder=''> </td>"+
                                      ...
                                      "<div class='form-group'>"+
                                         ...
                                         "<table>"+
                                            "<tr>"+
                                               "<td><input type='blue' class='form-control autocomplete' id='txt_rgb_blue' style='width: 275px;' placeholder=''> </td>"+
